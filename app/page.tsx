...
const games = [
  ...
  },
  {
    ...
    image: "/blockchain-puzzle-game.png",
    premium: true,
  },
  {
    id: 3,
    ...
    image: "/digital-strategy-game.png",
    premium: true,
  },
  {
    id: 4,
    ...
    image: "/diverse-group-futuristic-setting.png",
    premium: true,
  },
  {
    id: 5,
    ...
    image: "/diverse-futuristic-avatars.png",
    premium: true,
  },
]
    ...
    <div className="min-h-screen bg-[#0f1218] text-white">
      ...
      <header className="border-b border-slate-800/40 bg-[#0f1218]/70 backdrop-blur-xl fixed top-0 left-0 right-0 z-50">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link
              href="/arenas"
              className="px-3 py-1 rounded-full bg-slate-800/60 border border-purple-500/30 text-purple-300 hover:bg-slate-700/70 hover:text-white transition"
            >
              Battlegrounds
            </Link>
          </nav>
          <Button
            ...
            className="bg-gradient-to-r from-yellow-400 to-purple-600 hover:from-yellow-500 hover:to-purple-700 text-black font-medium"
          >
      ...
      <section className="min-h-screen flex flex-col justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="mb-20">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-500 via-cyan-400 to-yellow-300 text-transparent bg-clip-text tracking-tight">
              SkillZChain
            </h1>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white tracking-wide drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-16">
            {!walletConnected && (
              <Button
                onClick={handleConnectWallet}
                className="bg-gradient-to-r from-yellow-400 to-purple-600 hover:from-yellow-500 hover:to-purple-700 text-black font-medium px-8 py-6 text-lg rounded-full"
              >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-slate-800/30 backdrop-blur-md rounded-xl p-8 border border-slate-700/50 shadow-lg shadow-purple-900/10">
              <div className="flex flex-col items-center">
                <div className="w-full">
                  ...
                  <div className="text-center">
                    <Link href="/about">
                      <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-medium rounded-full px-6 py-3 text-lg">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
              {/* Step 1 */}
              <div className="bg-slate-800/40 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 shadow-lg shadow-purple-900/10 flex flex-col items-center text-center relative z-10">
                <div className="bg-gradient-to-r from-purple-500 to-cyan-400 w-12 h-12 rounded-full flex items-center justify-center mb-4">
                  <Play className="h-5 w-5 text-white" />
                </div>
                <h3 className="font-bold mb-2">Play Games</h3>
                <p className="text-slate-300 text-sm">Compete in skill-based games and challenges</p>
              </div>

              {/* Step 2 */}
              <div className="bg-slate-800/40 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 shadow-lg shadow-purple-900/10 flex flex-col items-center text-center relative z-10">
                <div className="bg-gradient-to-r from-cyan-400 to-blue-500 w-12 h-12 rounded-full flex items-center justify-center mb-4">
                  <Trophy className="h-5 w-5 text-white" />
                </div>
                <h3 className="font-bold mb-2">Win Matches</h3>
                <p className="text-slate-300 text-sm">Demonstrate your skills and climb the leaderboards</p>
              </div>
              ...
              <div className="bg-slate-800/40 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 shadow-lg shadow-purple-900/10 flex flex-col items-center text-center relative z-10">
                ...
                <h3 className="font-bold mb-2">Earn SKILLZ</h3>
                <p className="text-slate-300 text-sm">Receive tokens based on your performance</p>
              </div>

              {/* Step 4 */}
              <div className="bg-slate-800/40 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 shadow-lg shadow-purple-900/10 flex flex-col items-center text-center relative z-10">
                <div className="bg-gradient-to-r from-purple-500 to-yellow-400 w-12 h-12 rounded-full flex items-center justify-center mb-4">
                  <Gift className="h-5 w-5 text-white" />
                </div>
                <h3 className="font-bold mb-2">Get Rewards</h3>
                <p className="text-slate-300 text-sm">Exchange tokens for NFTs and other exciting rewards</p>
              </div>
            </div>

            <div className="text-center mt-10">
              <Link href="/how-it-works">
                <Button className="bg-gradient-to-r from-purple-500 to-cyan-400 hover:from-purple-600 hover:to-cyan-500 text-white font-medium rounded-full px-6">
                  Learn More <ChevronRight className="ml-1 h-4 w-4" />
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto text-center mb-12">
            Redefining competitive gaming with blockchain technology and skill-based rewards
          </p>

          <div className="max-w-6xl mx-auto">
            {/* Main value proposition */}
            <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-md p-8 rounded-2xl border border-slate-700/50 shadow-lg shadow-purple-900/10 mb-12">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="md:w-1/2">
                  <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-yellow-400 to-purple-500 text-transparent bg-clip-text">
                ...
                <div className="md:w-1/2 flex justify-center">
                  <div className="relative w-full max-w-md aspect-square">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="bg-slate-800/80 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 shadow-lg">
                        <Sparkles className="h-16 w-16 text-yellow-400 mx-auto mb-4" />
                        <div className="text-center">
                          <h4 className="font-bold text-xl mb-1">Skill-Based Economy</h4>
                          <p className="text-slate-300 text-sm">Your skills determine your rewards</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 hover:border-purple-500/30 transition-all duration-300 shadow-lg hover:shadow-purple-900/20 group">
                <div className="bg-gradient-to-br from-purple-400/20 to-purple-600/20 p-3 rounded-lg inline-flex mb-4 group-hover:from-purple-400/30 group-hover:to-purple-600/30 transition-all duration-300">
                  <Target className="h-8 w-8 text-purple-400" />
                </div>
                <h3 className="text-xl font-bold mb-2 text-white">Meritocratic Rewards</h3>
              ...
              <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 hover:border-cyan-500/30 transition-all duration-300 shadow-lg hover:shadow-cyan-900/20 group">
                <div className="bg-gradient-to-br from-cyan-400/20 to-cyan-600/20 p-3 rounded-lg inline-flex mb-4 group-hover:from-cyan-400/30 group-hover:to-cyan-600/30 transition-all duration-300">
                  <Layers className="h-8 w-8 text-cyan-400" />
                </div>
                <h3 className="text-xl font-bold mb-2 text-white">Blockchain Transparency</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 hover:border-yellow-500/30 transition-all duration-300 shadow-lg hover:shadow-yellow-900/20 group">
                <div className="bg-gradient-to-br from-yellow-400/20 to-yellow-600/20 p-3 rounded-lg inline-flex mb-4 group-hover:from-yellow-400/30 group-hover:to-yellow-600/30 transition-all duration-300">
            ...
            <div className="text-center">
              <Button className="bg-gradient-to-r from-purple-500 to-cyan-400 hover:from-purple-600 hover:to-cyan-500 text-white font-medium rounded-full px-8 py-3 text-lg">
                <Rocket className="mr-2 h-5 w-5" /> Join the Revolution
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-900/30">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 backdrop-blur-md rounded-2xl p-8 border border-slate-700/50 shadow-lg shadow-purple-900/10">
            <h2 className="text-3xl font-bold mb-8 text-center">
              <span className="bg-gradient-to-r from-yellow-300 to-yellow-500 text-transparent bg-clip-text">
                Featured Games
              </span>
            </h2>
            <GameCarousel games={games} walletConnected={walletConnected} onConnectWallet={handleConnectWallet} />
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-green-400 to-teal-500 text-transparent bg-clip-text">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-left mb-10">
              <div className="bg-slate-800/30 backdrop-blur-sm p-6 rounded-xl border border-slate-700/50">
                <h3 className="text-xl font-bold mb-3 text-green-400">Speed & Efficiency</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-slate-800/30 backdrop-blur-sm p-6 rounded-xl border border-slate-700/50">
                <h3 className="text-xl font-bold mb-3 text-green-400">Low Transaction Costs</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-slate-800/30 backdrop-blur-sm p-6 rounded-xl border border-slate-700/50">
                <h3 className="text-xl font-bold mb-3 text-green-400">Carbon-Negative Blockchain</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-slate-800/30 backdrop-blur-sm p-6 rounded-xl border border-slate-700/50">
                <h3 className="text-xl font-bold mb-3 text-green-400">Smart Contract Reliability</h3>
                <p className="text-slate-300">
            ...
            <a href="https://algorand.co/" target="_blank" rel="noopener noreferrer">
              <Button className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white font-medium rounded-full px-6 py-3">
